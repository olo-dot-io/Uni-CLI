---
title: Uni-CLI FAQ
description: Answers to the most common questions about the Uni-CLI Agent-Computer Interface runtime, its software boundaries, evidence, protocols, and repair loop.
---
