...
v0.220.0 covers <span><!-- STATS:site_count -->271<!-- /STATS --></span> sites with <span><!-- STATS:command_count -->1632<!-- /STATS --></span> commands across <span><!-- STATS:adapter_count_total -->1124<!-- /STATS --></span> adapters, <span><!-- STATS:pipeline_step_count -->101<!-- /STATS --></span> pipeline steps, and <span><!-- STATS:test_count -->8279<!-- /STATS --></span> tests. Coverage spans social platforms, developer tools, Chinese platforms, scholarly databases, government policy, podcasts, and macOS apps.
