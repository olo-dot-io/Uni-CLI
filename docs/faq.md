...
v1.0.2 ships <span><!-- STATS:site_count -->326<!-- /STATS --></span> sites in the static adapter catalog.

The same catalog contains <span><!-- STATS:command_count -->1830<!-- /STATS --></span> registered commands. Core commands and host-discovered tools join at runtime. Browse the [operation catalog](/reference/sites) or run `unicli list`.
