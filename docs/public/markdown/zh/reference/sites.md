...
这个目录来自适配器 manifest：223 个站点，1304 条命令。

| 站点 | 接口类型 | 命令数 | 认证 | 示例命令 |
| --- | --- | ---: | --- | --- |
| 1688 | web-api | 3 | 是 | unicli 1688 item<br>unicli 1688 search<br>unicli 1688 store |
...
| bilibili | web-api | 17 | 是 | unicli bilibili coin<br>unicli bilibili dynamic<br>unicli bilibili favorites |
| binance | web-api | 3 | 否 | unicli binance hot<br>unicli binance kline<br>unicli binance ticker |
...
| codex | web-api | 15 | 否 | unicli codex extract-diff<br>unicli codex ask<br>unicli codex send |
...
| deepseek | web-api | 2 | 是 | unicli deepseek chat<br>unicli deepseek models |
...
| doubao | web-api | 3 | 是 | unicli doubao ask<br>unicli doubao new<br>unicli doubao status |
...
| eastmoney | web-api | 4 | 否 | unicli eastmoney fund<br>unicli eastmoney hot<br>unicli eastmoney market |
...
| gitee | web-api | 3 | 否 | unicli gitee repos<br>unicli gitee search<br>unicli gitee trending |
...
| jd | web-api | 3 | 是 | unicli jd hot<br>unicli jd item<br>unicli jd search |
| jianyu | browser | 1 | 是 | unicli jianyu search |
| jike | browser | 10 | 是 | unicli jike feed<br>unicli jike notifications<br>unicli jike post |
| jimeng | web-api | 2 | 是 | unicli jimeng generate<br>unicli jimeng history |
...
| ke | browser | 2 | 是 | unicli ke ershoufang<br>unicli ke xiaoqu |
...
| linux-do | web-api | 10 | 是 | unicli linux-do categories<br>unicli linux-do category<br>unicli linux-do feed |
...
| maimai | browser | 1 | 是 | unicli maimai search |
...
| mubu | web-api | 2 | 是 | unicli mubu list<br>unicli mubu search |
...
| quark | web-api | 2 | 是 | unicli quark ls<br>unicli quark search |
...
| spotify | web-api | 17 | 是 | unicli spotify now-playing<br>unicli spotify playlists<br>unicli spotify search |
...
| taobao | browser | 2 | 是 | unicli taobao hot<br>unicli taobao search |
...
| toutiao | web-api | 2 | 是 | unicli toutiao hot<br>unicli toutiao search |
| twitch | web-api | 4 | 是 | unicli twitch games<br>unicli twitch search<br>unicli twitch streams |
| twitter | web-api | 34 | 是 | unicli twitter lists<br>unicli twitter media<br>unicli twitter mentions |
...
| weixin | browser | 4 | 是 | unicli weixin article<br>unicli weixin download<br>unicli weixin hot |
| weread | web-api | 7 | 是 | unicli weread book<br>unicli weread highlights<br>unicli weread notebooks |
...
| xiaoyuzhou | web-api | 3 | 否 | unicli xiaoyuzhou episode<br>unicli xiaoyuzhou podcast-episodes<br>unicli xiaoyuzhou podcast |
| xueqiu | web-api | 12 | 是 | unicli xueqiu comments<br>unicli xueqiu earnings-date<br>unicli xueqiu feed |
...
| youtube | web-api | 8 | 是 | unicli youtube playlist<br>unicli youtube shorts<br>unicli youtube trending |
...
| zhihu | web-api | 21 | 是 | unicli zhihu answer<br>unicli zhihu answers<br>unicli zhihu article |
...
| antigravity | web-api | 14 | 否 | unicli antigravity ask<br>unicli antigravity send<br>unicli antigravity read |
| chatgpt | web-api | 14 | 否 | unicli chatgpt ask<br>unicli chatgpt send<br>unicli chatgpt read |
| chatwise | web-api | 14 | 否 | unicli chatwise ask<br>unicli chatwise send<br>unicli chatwise read |
