...
This catalog is generated from the adapter manifest: 223 sites, 1304 commands.

| Site | Surface | Commands | Auth | Example commands |
| --- | --- | ---: | --- | --- |
| 1688 | web-api | 3 | yes | unicli 1688 item<br>unicli 1688 search<br>unicli 1688 store |
...
| bbc | web-api | 4 | no | unicli bbc news<br>unicli bbc technology<br>unicli bbc top |
| bilibili | web-api | 17 | yes | unicli bilibili coin<br>unicli bilibili dynamic<br>unicli bilibili favorites |
| binance | web-api | 3 | no | unicli binance hot<br>unicli binance kline<br>unicli binance ticker |
...
| codex | web-api | 15 | no | unicli codex extract-diff<br>unicli codex ask<br>unicli codex send |
...
| deepseek | web-api | 2 | yes | unicli deepseek chat<br>unicli deepseek models |
| devto | web-api | 5 | no | unicli devto latest<br>unicli devto search<br>unicli devto tag |
| dianping | web-api | 2 | yes | unicli dianping hot<br>unicli dianping search |
...
| doubao | web-api | 3 | yes | unicli doubao ask<br>unicli doubao new<br>unicli doubao status |
...
| eastmoney | web-api | 4 | no | unicli eastmoney fund<br>unicli eastmoney hot<br>unicli eastmoney market |
...
| facebook | web-api | 12 | yes | unicli facebook add-friend<br>unicli facebook events<br>unicli facebook feed |
...
| gitee | web-api | 3 | no | unicli gitee repos<br>unicli gitee search<br>unicli gitee trending |
...
| gitlab | web-api | 3 | no | unicli gitlab projects<br>unicli gitlab search<br>unicli gitlab trending |
...
| grok | web-api | 1 | yes | unicli grok ask |
| hackernews | web-api | 10 | no | unicli hackernews ask<br>unicli hackernews best<br>unicli hackernews comments |
| hermes | desktop | 3 | no | unicli hermes sessions-search<br>unicli hermes skills-list<br>unicli hermes skills-read |
| hf | web-api | 4 | no | unicli hf datasets<br>unicli hf models<br>unicli hf spaces |
| homebrew | web-api | 2 | no | unicli homebrew info<br>unicli homebrew search |
...
| instagram | web-api | 26 | yes | unicli instagram activity<br>unicli instagram comment<br>unicli instagram explore |
| ip-info | web-api | 1 | no | unicli ip-info lookup |
| itch-io | web-api | 3 | no | unicli itch-io popular<br>unicli itch-io search<br>unicli itch-io top |
| ithome | web-api | 3 | no | unicli ithome hot<br>unicli ithome latest<br>unicli ithome news |
| jd | web-api | 3 | yes | unicli jd hot<br>unicli jd item<br>unicli jd search |
| jianyu | browser | 1 | yes | unicli jianyu search |
| jike | browser | 10 | yes | unicli jike feed<br>unicli jike notifications<br>unicli jike post |
| jimeng | web-api | 2 | yes | unicli jimeng generate<br>unicli jimeng history |
...
| ke | browser | 2 | yes | unicli ke ershoufang<br>unicli ke xiaoqu |
...
| linux-do | web-api | 10 | yes | unicli linux-do categories<br>unicli linux-do category<br>unicli linux-do feed |
...
| maimai | browser | 1 | yes | unicli maimai search |
...
| mubu | web-api | 2 | yes | unicli mubu list<br>unicli mubu search |
...
| quark | web-api | 2 | yes | unicli quark ls<br>unicli quark search |
| qweather | web-api | 2 | no | unicli qweather forecast<br>unicli qweather now |
| railway | bridge | 1 | no | unicli railway deploy |
| reddit | web-api | 20 | yes | unicli reddit comment<br>unicli reddit comments<br>unicli reddit read |
...
| sketch | desktop | 3 | no | unicli sketch artboards<br>unicli sketch export<br>unicli sketch symbols |
| slack | web-api | 14 | yes | unicli slack channels<br>unicli slack messages<br>unicli slack post |
...
| spotify | web-api | 17 | yes | unicli spotify now-playing<br>unicli spotify playlists<br>unicli spotify search |
| sspai | web-api | 2 | no | unicli sspai hot<br>unicli sspai latest |
| stackoverflow | web-api | 6 | no | unicli stackoverflow bounties<br>unicli stackoverflow hot<br>unicli stackoverflow question |
| stagehand | bridge | 1 | no | unicli stagehand wrap-observe |
| steam | web-api | 6 | no | unicli steam app-details<br>unicli steam new-releases<br>unicli steam search |
...
| taobao | browser | 2 | yes | unicli taobao hot<br>unicli taobao search |
...
| threads | web-api | 2 | yes | unicli threads hot<br>unicli threads search |
| tieba | web-api | 4 | no | unicli tieba hot<br>unicli tieba posts<br>unicli tieba read |
| tiktok | web-api | 16 | yes | unicli tiktok comment<br>unicli tiktok explore<br>unicli tiktok follow |
| toutiao | web-api | 2 | yes | unicli toutiao hot<br>unicli toutiao search |
| twitch | web-api | 4 | yes | unicli twitch games<br>unicli twitch search<br>unicli twitch streams |
| twitter | web-api | 34 | yes | unicli twitter lists<br>unicli twitter media<br>unicli twitter mentions |
...
| weibo | web-api | 10 | yes | unicli weibo comments<br>unicli weibo feed<br>unicli weibo hot |
| weixin | browser | 4 | yes | unicli weixin article<br>unicli weixin download<br>unicli weixin hot |
| weread | web-api | 7 | yes | unicli weread book<br>unicli weread highlights<br>unicli weread notebooks |
| wikipedia | web-api | 5 | no | unicli wikipedia random<br>unicli wikipedia search<br>unicli wikipedia summary |
...
| xianyu | web-api | 3 | yes | unicli xianyu chat<br>unicli xianyu item<br>unicli xianyu search |
...
| xiaoyuzhou | web-api | 3 | no | unicli xiaoyuzhou episode<br>unicli xiaoyuzhou podcast-episodes<br>unicli xiaoyuzhou podcast |
| xueqiu | web-api | 12 | yes | unicli xueqiu comments<br>unicli xueqiu earnings-date<br>unicli xueqiu feed |
...
| youtube | web-api | 8 | yes | unicli youtube playlist<br>unicli youtube shorts<br>unicli youtube trending |
| yt-dlp | bridge | 4 | no | unicli yt-dlp download<br>unicli yt-dlp extract-audio<br>unicli yt-dlp info |
| yuanbao | web-api | 3 | yes | unicli yuanbao ask<br>unicli yuanbao new<br>unicli yuanbao shared |
| zhihu | web-api | 21 | yes | unicli zhihu answer<br>unicli zhihu answers<br>unicli zhihu article |
...
| antigravity | web-api | 14 | no | unicli antigravity ask<br>unicli antigravity send<br>unicli antigravity read |
| chatgpt | web-api | 14 | no | unicli chatgpt ask<br>unicli chatgpt send<br>unicli chatgpt read |
| chatwise | web-api | 14 | no | unicli chatwise ask<br>unicli chatwise send<br>unicli chatwise read |
...
| insomnia | web-api | 7 | no | unicli insomnia open-app<br>unicli insomnia status-app<br>unicli insomnia dump |
| bitwarden | web-api | 7 | no | unicli bitwarden open-app<br>unicli bitwarden status-app<br>unicli bitwarden dump |
| signal | web-api | 7 | no | unicli signal open-app<br>unicli signal status-app<br>unicli signal dump |
| whatsapp | web-api | 7 | no | unicli whatsapp open-app<br>unicli whatsapp status-app<br>unicli whatsapp dump |
| teams | web-api | 7 | no | unicli teams open-app<br>unicli teams status-app<br>unicli teams dump |
| todoist | web-api | 7 | no | unicli todoist open-app<br>unicli todoist status-app<br>unicli todoist dump |
| github-desktop | web-api | 7 | no | unicli github-desktop open-app<br>unicli github-desktop status-app<br>unicli github-desktop dump |
| gitkraken | web-api | 7 | no | unicli gitkraken open-app<br>unicli gitkraken status-app<br>unicli gitkraken dump |
| docker-desktop | web-api | 7 | no | unicli docker-desktop open-app<br>unicli docker-desktop status-app<br>unicli docker-desktop dump |
| lm-studio | web-api | 7 | no | unicli lm-studio open-app<br>unicli lm-studio status-app<br>unicli lm-studio dump |
| claude | web-api | 7 | no | unicli claude open-app<br>unicli claude status-app<br>unicli claude dump |
