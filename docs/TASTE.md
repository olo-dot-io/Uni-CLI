...
>
> **Current scale:** <!-- STATS:site_count -->198<!-- /STATS --> sites, <!-- STATS:command_count -->962<!-- /STATS --> commands, <!-- STATS:adapter_count_total -->962<!-- /STATS --> adapters (<!-- STATS:adapter_count_yaml -->890<!-- /STATS --> YAML + <!-- STATS:adapter_count_ts -->72<!-- /STATS --> TS), <!-- STATS:test_count -->1101<!-- /STATS --> tests. Numbers render from `stats.json` via `npm run build`; drift fails `npm run stats:check`.
