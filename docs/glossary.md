...
description: Definitions for every Uni-CLI term — adapter, AgentEnvelope, strategy cascade, pipeline step, self-repair, and the conventions used across the project.
---
