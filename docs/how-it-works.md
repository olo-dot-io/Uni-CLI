...
description: A deep walkthrough of the Uni-CLI execution model — the YAML adapter format, the v2 AgentEnvelope, strategy cascade, the 59-step pipeline, and the self-repair loop that lets agents fix their own integrations.
---
...
<span><!-- STATS:site_count -->238<!-- /STATS --></span> sites and
<span><!-- STATS:command_count -->1458<!-- /STATS --></span> commands. One error
