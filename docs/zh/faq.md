...
v0.220.0 覆盖 <span><!-- STATS:site_count -->268<!-- /STATS --></span> 个站点、<span><!-- STATS:command_count -->1616<!-- /STATS --></span> 条命令、<span><!-- STATS:adapter_count_total -->1113<!-- /STATS --></span> 个适配器、<span><!-- STATS:pipeline_step_count -->101<!-- /STATS --></span> 个 pipeline step、<span><!-- STATS:test_count -->8212<!-- /STATS --></span> 个测试。社交平台、开发者工具、中文站点、学术数据库、政府政策、播客、macOS 应用都覆盖了。
