...
> Current: v0.224.0 — Apollo · Armstrong. <!-- STATS:site_count -->311<!-- /STATS --> 个站点，<!-- STATS:command_count -->1756<!-- /STATS --> 条命令，<!-- STATS:pipeline_step_count -->103<!-- /STATS --> 个 pipeline step。
...
5. 为不完整 AX 壳的 Electron 应用加入 CDP、a11y、后台动作、Visual 的分层 fallback。
