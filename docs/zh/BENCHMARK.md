...
- <span><!-- STATS:site_count -->286<!-- /STATS --></span> 个站点。
- <span><!-- STATS:command_count -->1700<!-- /STATS --></span> 条命令。
- <span><!-- STATS:adapter_count_yaml -->955<!-- /STATS --></span> 个 schema-v2 YAML adapter。
- <span><!-- STATS:pipeline_step_count -->101<!-- /STATS --></span> 个 pipeline steps。
- <span><!-- STATS:test_count -->8500<!-- /STATS --></span> 个测试。
