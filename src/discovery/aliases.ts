 ...
 * @breaks  Throws at module load on duplicate alias keys; missing aliases or categories degrade command discovery relevance.
 */

/**
 * Map constructor that throws on duplicate keys. JS Map literals silently
 * keep the last duplicate, which already cost a synonym in production
 * (行情 appeared twice and dropped "market"); a hand-maintained table this
 * size must fail loudly at load instead.
 */
export function strictMap<K, V>(
  entries: ReadonlyArray<readonly [K, V]>,
): ReadonlyMap<K, V> {
  const aliasTable = new Map<K, V>();
  for (const [key, value] of entries) {
    if (aliasTable.has(key)) {
      throw new Error(`Duplicate alias key: ${String(key)}`);
    }
    aliasTable.set(key, value);
  }
  return aliasTable;
}
...
export const SITE_ALIASES: ReadonlyMap<string, string> = strictMap([
  // Chinese social
  ["推特", "twitter"],
  ["微博", "weibo"],
  ["知乎", "zhihu"],
  ...
  ["谷歌学术", "google-scholar"],
  ["马克思主义文库", "marxists-cn"],
  ["中文马克思主义文库", "marxists-cn"],
  ["马克思文库", "marxists-cn"],
  ["西马", "marxists-cn"],
  ["西方马克思主义", "marxists-cn"],
  ["西方马克思主义文库", "marxists-cn"],
  ["marxists", "marxists-cn"],
  ["marxists.org", "marxists-cn"],
  ["国家法律法规库", "gov-law"],
  ["政策文件库", "gov-policy"],
  ["剑鱼", "jianyu"],
  ["电建", "powerchina"],
...
export const ACTION_ALIASES: ReadonlyMap<string, readonly string[]> = strictMap(
  [
    // Search intent
    ...
    ["recommendation", ["recommend", "feed", "suggested"]],
    ["recommendations", ["recommend", "feed", "suggested"]],
    ["personalized", ["recommend", "feed", "home", "for-you"]],
    ["personalised", ["recommend", "feed", "home", "for-you"]],
    ["列表", ["list", "all"]],
    ...
    ["订阅", ["subscribe", "subscriptions", "following"]],
    ["粉丝", ["followers", "fans"]],
...
export const DOMAIN_ALIASES: ReadonlyMap<string, readonly string[]> = strictMap(
  [
    ...
    ["字幕", ["subtitle", "subtitles", "transcript", "caption"]],
    ["逐字稿", ["transcript", "subtitles", "text"]],
    ...
    ["压缩", ["compress", "encode", "convert"]],
    ["热映", ["hot", "movie", "movies", "playing"]],
    ...
    ["动态", ["feed", "dynamic", "timeline", "moments"]],
    ["时间线", ["timeline", "feed"]],
    ["收藏", ["favorites", "favorite", "bookmark", "bookmarks", "saved"]],
    ["saved", ["saved", "bookmarks", "favorites", "collections"]],
    ["bookmark", ["bookmark", "bookmarks", "saved", "favorites"]],
    ["bookmarks", ["bookmarks", "saved", "favorites"]],
    ["favorites", ["favorites", "saved", "bookmarks"]],
    ["历史", ["history", "recent", "watched"]],
    ["稍后看", ["watch-later", "later", "saved"]],
    ["推文", ["tweet", "tweets", "post", "twitter"]],
    ["回答", ["answer", "answers"]],
    ["笔记", ["note", "notes"]],
    ["对话", ["chat", "ask", "conversation", "talk"]],
    ["每日", ["daily"]],
    ["词典", ["dictionary", "definition", "word"]],
    ["news", ["news", "article", "headline"]],
    ["article", ["article", "post", "story"]],

    // Tech / Dev
    ["代码", ["code", "repo", "source"]],
    ["源码", ["source", "code", "implementation", "repository"]],
    ["仓库", ["repo", "repository", "project"]],
    ["包", ["package", "module", "library"]],
    ["开源", ["opensource", "repo", "github"]],
    [
      "技术栈",
      ["technology", "stack", "language", "topic", "repository", "code"],
    ],
    ["功能", ["feature", "implementation", "code", "issue", "pull", "commit"]],
    ["特性", ["feature", "implementation", "code", "issue", "pull", "commit"]],
    ["提交", ["commit", "commits", "change", "history"]],
    ["PR", ["pr", "pull", "request", "review", "feature"]],
    ["pr", ["pr", "pull", "request", "review", "feature"]],
    ["拉取请求", ["pr", "pull", "request", "review", "feature"]],
    ["issue", ["issue", "issues", "bug", "feature", "request"]],
    ["issues", ["issues", "issue", "bug", "feature", "request"]],
    ["议题", ["issue", "issues", "discussion", "feature", "request"]],
    ["维护者", ["maintainer", "author", "user", "owner", "contributor"]],
    [
      "模糊关键词",
      ["fuzzy", "keyword", "best", "match", "topic", "repository", "issue"],
    ],
    ...
    // Desktop / System
    ["通知", ["notification", "notifications", "notify", "alert"]],
    ["notifications", ["notification", "notifications", "notify"]],
    ["mentions", ["mentions", "notifications", "activity"]],
    ["inbox", ["inbox", "messages", "notifications"]],
    ["subscriptions", ["subscriptions", "following", "feed"]],
    ["电池", ["battery", "power"]],
    ["亮度", ["brightness", "display"]],
    ["音量", ["volume", "sound", "audio"]],
    ["缩放", ["resize", "scale", "zoom"]],
    ...
    [
      "学术源",
      ["academic", "scholar", "scholarly", "coverage", "source", "sources"],
    ],
    [
      "来源对比",
      ["coverage", "compare", "comparison", "source", "sources", "sites"],
    ],
    ["覆盖矩阵", ["coverage", "matrix", "gap", "gaps", "sources"]],
    ["学术缺口", ["academic", "scholar", "coverage", "gap", "gaps"]],
    [
      "文献",
      [
        "literature",
    ...
    ["审稿", ["review", "reviews", "peer", "openreview", "paper"]],
    ["评审", ["review", "reviews", "peer", "openreview", "paper"]],
    [
      "同行评审",
      ["peer", "review", "reviews", "openreview", "paper", "decision"],
    ],
    [
      "审稿意见",
      ["review", "reviews", "peer", "openreview", "paper", "decision"],
    ],
    [
      "评审意见",
      ["review", "reviews", "peer", "openreview", "paper", "decision"],
    ],
    ["接收决定", ["decision", "review", "reviews", "openreview", "paper"]],
    ["作者回复", ["rebuttal", "review", "reviews", "openreview", "paper"]],
    [
      "学术联动",
      ["academic", "scholar", "trace", "link", "cross-site", "paper"],
    ],
    ["跨站追踪", ["trace", "link", "cross-site", "paper", "award", "review"]],
    [
      "最佳论文",
      ["best", "paper", "award", "conference", "official", "scholar"],
    ],
    ["论文奖项", ["paper", "award", "awards", "conference", "official"]],
    ["期刊", ["journal", "publication", "paper", "papers"]],
    ["会议论文", ["conference", "paper", "papers", "proceedings"]],
    ["论文代码", ["paper", "code", "repo", "repository", "github"]],
    [
      "论文复现",
      ["paper", "reproduce", "reproducibility", "replicate", "code", "dataset"],
    ],
    [
      "代码安装",
      ["paper", "install", "installation", "setup", "environment", "code"],
    ],
    ["运行代码", ["paper", "run", "code", "setup", "environment", "reproduce"]],
    [
      "复现实验",
      ["paper", "reproduce", "replicate", "experiment", "code", "dataset"],
    ],
    ["数据集", ["dataset", "datasets", "data", "paper"]],
    ["论文数据", ["dataset", "datasets", "data", "paper"]],
    [
      "论文审计",
      [
        "paper",
    ...
    [
      "论文来源对比",
      ["paper", "source", "sources", "compare", "evidence", "audit"],
    ],
    [
      "论文来源逐站点对比",
      [
    ...
    [
      "逐站点对比",
      ["source", "sources", "site", "sites", "compare", "paper", "evidence"],
    ],
    [
      "站点对比",
      ["source", "sources", "site", "sites", "compare", "paper", "evidence"],
    ...
    [
      "学术闭环",
      ["academic", "scholar", "workflow", "runbook", "closed", "loop", "agent"],
    ],
    [
      "完整闭环",
      ["workflow", "runbook", "closed", "loop", "end-to-end", "agent", "paper"],
    ],
    [
      "闭环工作流",
      [
    ...
    ["论文闭环", ["paper", "workflow", "runbook", "closed", "loop", "agent"]],
    [
      "文献闭环",
      ["literature", "paper", "workflow", "runbook", "closed", "loop", "agent"],
    ],
    [
      "学术工作流",
      ["academic", "scholar", "workflow", "runbook", "step", "steps"],
    ],
    ["论文工作流", ["paper", "workflow", "runbook", "step", "steps", "agent"]],
    ["Agent闭环", ["agent", "workflow", "runbook", "closed", "loop", "paper"]],
    [
      "操作闭环",
      ["workflow", "runbook", "closed", "loop", "step", "steps", "agent"],
    ],
    ["可读", ["availability", "available", "read", "fulltext", "paper"]],
    [
      "证据分级",
      ["paper", "evidence", "classify", "classification", "citation", "safety"],
    ],
    [
      "引用安全",
      ["paper", "citation", "safety", "evidence", "verify", "source"],
    ],
    [
      "一手证据",
      ["paper", "primary", "source", "evidence", "provenance", "verified"],
    ],
    [
      "可信文献",
      ["paper", "trustworthy", "evidence", "verify", "citation", "safety"],
    ],
    [
      "幻觉文献",
      ["paper", "evidence", "classify", "citation", "safety", "hallucination"],
    ],
    ["模型", ["model", "models", "paper"]],
    ...
    [
      "literature",
      ["literature", "publication", "paper", "papers", "research"],
    ],
    ...
    ["dataset", ["dataset", "datasets", "data", "paper"]],
    ["datasets", ["datasets", "dataset", "data", "paper"]],
    ["model", ["model", "models", "paper"]],
    ["models", ["models", "model", "paper"]],
    ...
    ["datacite", ["datacite", "doi", "dataset", "software", "metadata"]],
    ["ccf", ["ccf", "ccfa", "conference", "ranking", "scholar"]],
    ["ccfa", ["ccf", "ccfa", "a-class", "conference", "ranking"]],
    [
      "CCF推荐",
      ["ccf", "ccfa", "conference", "ranking", "directory", "official"],
    ],
    [
      "A类会议",
      ["ccf", "ccfa", "a-class", "conference", "ranking", "official"],
    ],
    ["目录", ["directory", "catalog", "list"]],
    ["acm", ["acm", "conference", "paper", "proceedings", "doi"]],
    ["usenix", ["usenix", "conference", "paper", "proceedings", "pdf"]],
    ["sigchi", ["sigchi", "chi", "hci", "conference", "award", "paper"]],
    ["chi", ["chi", "sigchi", "hci", "conference", "award", "paper"]],
    [
      "国际学习表征会议",
      ["iclr", "openreview", "conference", "award", "review", "paper"],
    ],
    ["ieee", ["ieee", "xplore", "conference", "journal", "paper"]],
    ["xplore", ["ieee", "xplore", "conference", "journal", "paper"]],
    ["award", ["award", "awards", "best", "paper", "conference"]],
    ["awards", ["awards", "award", "best", "paper", "conference"]],
    ["trace", ["trace", "link", "cross-site", "paper", "source"]],
    ...
    ["aaai", ["aaai", "conference", "artificial", "intelligence", "paper"]],
    [
      "iclr",
      ["iclr", "openreview", "conference", "award", "rebuttal", "paper"],
    ],
    ...
    [
      "fse",
      ["fse", "software", "engineering", "conference", "paper", "papers"],
    ],
    [
      "ase",
      ["ase", "software", "engineering", "conference", "paper", "papers"],
    ],
    [
      "pldi",
      ["pldi", "programming", "language", "conference", "paper", "papers"],
    ],
    ["acmmm", ["acm", "mm", "multimedia", "conference", "paper"]],
    ["siggraph", ["acm", "siggraph", "graphics", "conference", "paper"]],
    ["ieeevis", ["ieee", "vis", "visualization", "conference", "paper"]],
    ["ubicomp", ["sigchi", "ubicomp", "ubiquitous", "computing", "paper"]],
    ["ubcomp", ["sigchi", "ubicomp", "ubiquitous", "computing", "paper"]],
    ["imwut", ["sigchi", "imwut", "ubicomp", "journal", "paper"]],
    ["rtss", ["ieee", "rtss", "real-time", "systems", "conference", "paper"]],
    ["fast", ["usenix", "fast", "storage", "conference", "paper"]],
    ["nsdi", ["usenix", "nsdi", "network", "systems", "conference", "paper"]],
    ["osdi", ["usenix", "osdi", "operating", "systems", "conference", "paper"]],
    ["usenix security", ["usenix", "security", "conference", "paper", "pdf"]],
    ["usenix atc", ["usenix", "atc", "conference", "paper", "pdf"]],
    ["experiment", ["experiment", "experiments", "method", "results", "paper"]],
    [
      "experiments",
      ["experiments", "experiment", "method", "results", "paper"],
    ],
    ...
    // Philosophy and Marxism archives
    [
      "马克思主义",
      ["marxism", "marxist", "marxists", "socialism", "philosophy"],
    ],
    [
      "西马",
      [
    ...
    [
      "法兰克福学派",
      ["frankfurt", "school", "western", "marxism", "marxist", "philosophy"],
    ],
    ["马克思", ["marx", "marxism", "marxist", "marxists"]],
    ["恩格斯", ["engels", "marxism", "marxist", "marxists"]],
    ["列宁", ["lenin", "marxism", "marxist", "marxists"]],
    ["葛兰西", ["gramsci", "western", "marxism", "marxist", "marxists"]],
    [
      "卢卡奇",
      ["lukacs", "western", "marxism", "marxist", "marxists", "dialectics"],
    ],
    ["科尔施", ["korsch", "western", "marxism", "marxist", "marxists"]],
    [
      "本雅明",
      ["benjamin", "western", "marxism", "marxist", "marxists", "frankfurt"],
    ],
    ["阿多诺", ["adorno", "frankfurt", "western", "marxism", "marxist"]],
    ["马尔库塞", ["marcuse", "frankfurt", "western", "marxism", "marxist"]],
    [
      "阿尔都塞",
      ["althusser", "western", "marxism", "marxist", "structuralism"],
    ],
    ["曼德尔", ["mandel", "western", "marxism", "marxist", "economics"]],
    ["著名", ["famous", "classic", "canonical", "canon"]],
    ["经典", ["classic", "canonical", "canon"]],
    ["人物", ["person", "people", "author", "authors"]],
    ["作者", ["author", "authors", "people"]],
    ["著作", ["work", "works", "book", "books", "text"]],
    ["作品", ["work", "works", "book", "books", "text"]],
    ["读书清单", ["reading", "list", "reading-list", "canon", "classic"]],
    ["阅读清单", ["reading", "list", "reading-list", "canon", "classic"]],
    ["社会主义", ["socialism", "marxism", "marxist"]],
    ["共产主义", ["communism", "marxism", "marxist"]],
    ["哲学", ["philosophy", "theory", "reference"]],
    ["辩证法", ["dialectics", "philosophy", "marxism"]],
    ["唯物主义", ["materialism", "philosophy", "marxism"]],
    ["marxism", ["marxism", "marxist", "marxists", "socialism"]],
    ["marxist", ["marxism", "marxist", "marxists", "socialism"]],
    ["socialism", ["socialism", "marxism", "marxist"]],
    ["communism", ["communism", "marxism", "marxist"]],
    ["philosophy", ["philosophy", "theory", "reference"]],
...
export const CATEGORY_ALIASES: ReadonlyMap<string, string> = strictMap([
  ["社交", "social"],
  ["社区", "social"],
  ["视频", "video"],
  ["短视频", "video"],
...
export function tokenizeQuery(query: string): string[] {
  ...
  for (const seg of segments) {
    if (seg.isChinese && seg.text.length > 1) {
      ...
      // English: keep the unsplit form (so hyphenated site names like
      // "yt-dlp" still match site lookups) and split on internal delimiters
      if (/[-_/]/.test(seg.text)) tokens.push(seg.text);
