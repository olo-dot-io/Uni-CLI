...
>
> Current scale: <!-- STATS:site_count -->237<!-- /STATS --> sites, <!-- STATS:command_count -->1453<!-- /STATS --> commands, <!-- STATS:adapter_count_total -->1043<!-- /STATS --> adapters (<!-- STATS:adapter_count_yaml -->920<!-- /STATS --> YAML + <!-- STATS:adapter_count_ts -->123<!-- /STATS --> TS), <!-- STATS:test_count -->7791<!-- /STATS --> tests.
