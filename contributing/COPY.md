...
>
> Current scale: <!-- STATS:site_count -->305<!-- /STATS --> sites, <!-- STATS:command_count -->1742<!-- /STATS --> commands, <!-- STATS:adapter_count_total -->1207<!-- /STATS --> adapters (<!-- STATS:adapter_count_yaml -->979<!-- /STATS --> YAML + <!-- STATS:adapter_count_ts -->228<!-- /STATS --> TS), <!-- STATS:test_count -->8815<!-- /STATS --> tests.
