...
function renderLlmsTxt(
  ...
  const lines = [
    "# Uni-CLI",
    "",
    "Uni-CLI is one CLI surface for AI agents to discover, run, prove, and repair operations across websites, logged-in browsers, desktop apps, local tools, external CLIs, MCP servers, and agent backends.",
    "",
    "## Catalog Snapshot",
    "",
    `- Sites: ${siteIndex.total_sites}`,
