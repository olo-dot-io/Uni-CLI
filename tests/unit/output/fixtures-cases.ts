/**
 * Golden-fixture cases for the md renderer.
 *
 * Extracted from fixtures.test.ts in v0.213.1 to stay under the 700-line
 * per-file complexity gate. The test runner reads {@link CASES} and compares
 * `renderMd(envelope)` against `tests/fixtures/md/<name>.md`.
 *
 * To regenerate fixtures after changing md output or adding a case:
 *   UPDATE_FIXTURES=1 npx vitest run tests/unit/output/fixtures.test.ts
 */
import type {
  AgentEnvelope,
  AgentEnvelopeOk,
...
export const CASES: Case[] = [
  ...
  // ── 10. unsplash.search — content[] canonical case (T12 / Fix #14, v0.213.1)
  // First battle-test of the optional envelope.content[] field shipped in
  // v0.213.0. This is what a download-step adapter (emit_content: true)
  // produces: a resource block per saved file plus a text summary.
  {
    name: "unsplash.search.success-with-content",
    envelope: {
      ok: true,
      schema_version: "2",
      command: "unsplash.search",
      meta: {
        duration_ms: 1203,
        count: 2,
        surface: "web",
      ...
      data: [
        {
          description: "A minimal desk with a laptop and coffee mug",
          author: "Jane Smith",
          url: "https://images.unsplash.com/photo-1",
          likes: 842,
          path: "/tmp/unsplash/a.jpg",
          mime: "image/jpeg",
          bytes: 384512,
        },
        {
          description: "Rainy street at night in Tokyo",
          author: "Hiro Tanaka",
          url: "https://images.unsplash.com/photo-2",
          likes: 1209,
          path: "/tmp/unsplash/b.jpg",
          mime: "image/jpeg",
          bytes: 512003,
        },
      ],
      error: null,
      content: [
        { type: "resource", uri: "file:///tmp/unsplash/a.jpg" },
        { type: "resource", uri: "file:///tmp/unsplash/b.jpg" },
        { type: "text", text: "downloaded 2 files, 896515 bytes total" },
      ],
    } satisfies AgentEnvelopeOk,
  },
