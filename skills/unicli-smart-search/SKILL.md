...
| **AI Infra** | `unicli ai profiles`, `unicli ai landscape`, `unicli ai pulse`, `unicli ai search <q>`, `unicli ai sources`, `unicli ai read <url>`, covering first-party labs, hardware, runtimes, model hubs, papers, code, talks, and communities |
...
| **Dev**      | `unicli github-trending daily`, `unicli producthunt hot`, `unicli docker-hub search <q>`                                                                                                                                             |
...
- With `--since`, dated source fields and explicitly prefixed search-index dates carry `timestamp_origin`. Undated records are excluded. `ai read <url>` refreshes the canonical candidate
